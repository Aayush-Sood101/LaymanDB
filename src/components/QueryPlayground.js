...
// Custom syntax highlighter theme for black & white
...
const QueryPlayground = () => {
  ...
  useEffect(() => {
    const savedHistory = localStorage.getItem('queryPlaygroundHistory');
    if (savedHistory) {
      try {
  ...
  useEffect(() => {
    if (queryHistory.length > 0) {
      localStorage.setItem('queryPlaygroundHistory', JSON.stringify(queryHistory));
    }
  }, [queryHistory]);
  ...
  const loadExampleQuestions = async () => {
    ...
    try {
      const response = await fetch('/api/query/examples', {
        method: 'POST',
        headers: {
      ...
      console.error('Error loading example questions:', err);
    } finally {
  ...
  const handleGenerateQuery = async (e) => {
    ...
    if (!currentSchema || !currentSchema.tables || currentSchema.tables.length === 0) {
      setError('Please generate a database schema first');
      return;
    }
  ...
  const handleHistorySelect = (historyItem) => {
    ...
    setDialect(historyItem.dialect);
    setError('');
  };

  const handleClearHistory = () => {
    setQueryHistory([]);
    localStorage.removeItem('queryPlaygroundHistory');
  };
          ...
          <div className="flex items-start justify-between">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-white">Query Playground</h1>
            ...
            <div className="text-center space-y-6 max-w-md">
              ...
              <div className="space-y-2">
                ...
                <p className="text-neutral-400">
                  Generate a database schema first to unlock the Query Playground
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-400 text-sm">
                      {currentSchema.tables?.length || 0} tables • Ready for queries
                    </p>
                  </div>
                </div>
              ...
              {isGenerating && (
                <div className="absolute inset-0 bg-black/80 backdrop-blur-sm z-10 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <div className="space-y-2">
                      <p className="text-white font-semibold text-lg">Generating SQL Query...</p>
                      <p className="text-neutral-400 text-sm">AI is analyzing your schema and crafting the perfect query</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="appearance-none bg-white text-black px-4 py-2 pr-10 rounded-lg font-medium cursor-pointer hover:bg-neutral-100 transition-colors focus:outline-none focus:ring-2 focus:ring-white/50"
                    >
                ...
                <form onSubmit={handleGenerateQuery} className="space-y-4">
                  ...
                  <div className="relative group">
                    <textarea
                      ...
                      placeholder="e.g., Show me all customers who made a purchase in the last 30 days"
            ...
            {generatedSQL && (
              <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm animate-in fade-in duration-500">
                ...
                <div className="p-6 space-y-6">
                  {/* SQL Code Block */}
                  <div className="rounded-lg overflow-hidden border-2 border-white/20 shadow-2xl">
                    <SyntaxHighlighter
                      language="sql"
                    ...
                    <div className="p-5 bg-white/10 border border-white/20 rounded-lg">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 space-y-2">
                          <h4 className="text-white font-semibold">How This Query Works</h4>
